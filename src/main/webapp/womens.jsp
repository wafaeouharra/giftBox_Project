...
<div class="footer">
	<div class="footer_agile_inner_info_w3l">
		<div class="col-md-3 footer-left">
			<h2><a href="../../test/index.html"><span>E</span>lite Shoppy </a></h2>
			...
			<div class="sign-grds">
				<div class="col-md-4 sign-gd">
					...
					<ul>
						...
						<li><a href="produit?id_cat=1&action=showBycat">Men</a></li>
						<li><a href="produit?id_cat=2&action=showBycat">Women</a></li>
						<li><a href="produit?id_cat=3&action=showBycat">Kids</a></li>
