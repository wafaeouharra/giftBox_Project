...
@Entity
@NamedQuery(name = "allProducts",query="SELECT p FROM Produit p")
@NamedQuery(name = "allProductsByCat",query="SELECT p FROM Produit p WHERE p.idCategorie = ?1")
@NamedQuery(name= "productById",query="SELECT p FROM Produit p WHERE p.idProduit = ?1")
